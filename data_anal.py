...
class DataAnalysis:
    ...
    def split_data_for_analysis(self):
        """
        Splits lines from CSV file by comma, creates a list of elements from one line and adds it to final_results list
        :return:
        """
...
if __name__ == '__main__':
    ...
    data1.analise_data(2, 4, 'Number of players','Duration of one round')
    data1.analise_data(3, 1,'Number of rounds', 'Number of players')
